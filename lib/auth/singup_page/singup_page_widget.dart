...
class _SingupPageWidgetState extends State<SingupPageWidget> {
  ...
  void initState() {
    ...
    _model.indiaTextController ??= TextEditingController(text: 'India');
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  final phoneNumberVal =
                                      '${functions.dialCode(_model.indiaTextController.text)}${_model.mobileNumberTextController.text}';
