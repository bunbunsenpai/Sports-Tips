...
import 'cricket_model.dart';
export 'cricket_model.dart';

class CricketWidget extends StatefulWidget {
  const CricketWidget({super.key});

  static String routeName = 'Cricket';
  static String routePath = '/cricket';

  @override
  State<CricketWidget> createState() => _CricketWidgetState();
}

class _CricketWidgetState extends State<CricketWidget> {
  late CricketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CricketModel());
                    ...
                    child: StreamBuilder<List<MatchesRecord>>(
                      stream: queryMatchesRecord(
                        queryBuilder: (matchesRecord) =>
                            matchesRecord.orderBy('startTime'),
                      ),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: Image.network(
                                                listViewMatchesRecord.team1Logo,
                                              ).image,
                                            ),
                                            shape: BoxShape.circle,
                                          ),
